		...
		/////////////////
			...
			DB.withConnection { implicit connection =>
				...
				SQL(sqlQuery2)().foreach { row2 =>
					...
					packages += new AssetPackage(row2[String]("name"), row2[String]("slug"),row2[Int]("id"),row2[String]("description"),row2[String]("url"),row2[String]("pictures"),row2[Int]("verified"),row2[String]("rejection_text"))
				}
